...
export const NTDDiagramsItemData: ItemData = {
  ...
  summary:
    'A site built on Node.JS with the Express.JS framework to display diagrams for a student sharing diagrams with a Biology class. MongoDB was used for posting and authentication (authentication no longer required for access), AWS for CDN, and Heroku as the hosting service. I have translated the site from Node.JS and Pug to flat HTML/JS/CSS which you can find linked above.',
};
